...
var SantaGame = {
	...
	load: {
		preload: function(){
			...
			this.game.load.image("instructions", "img/3.png");
			this.game.load.image("game-over", "img/4.png");
			this.game.load.image("startbtn", "img/2.png");
			this.game.load.image("playbtn", "img/2.png");
			this.game.load.image("restartBtn", "img/2.png");
		},
		create: function(){
	...
	title: {
		...
		create: function(){
			...
			this.logo = this.game.add.sprite(this.game.world.width/2 - 100, 20, 'logo');
			this.logo.alpha = 0;
			this.game.add.tween(this.logo).to({alpha: 1}, 1000, Phaser.Easing.Linear.None, true, 0);
			this.startBtn = this.game.add.button(this.game.world.width/2 - 110, this.game.world.height - 120, 'startbtn', this.startClicked);
...
// instructions screen
	instructions: {
		...
		create: function(){
			this.bg = this.game.add.tileSprite(0, 0, width, height, 'snow-bg');
			this.instructions = this.game.add.sprite(this.game.world.width/2 - 260, 30, 'instructions');
			this.instructions.alpha = 0;
			this.game.add.tween(this.instructions).to({alpha: 1}, 800, Phaser.Easing.Linear.None, true, 0);
			this.playBtn = this.game.add.button(this.game.world.width/2 - 100, this.game.world.height - 120, 'playbtn', this.playClicked);
	...
	gameOver: {
		...
		create: function(){
			this.bg = this.game.add.tileSprite(0, 0, width, height, 'snow-bg');
			this.msg = this.game.add.sprite(this.game.world.width/2 - 100, 50, 'game-over');
			this.msg.alpha = 0;
			...
			this.restartBtn = this.game.add.button(this.game.world.width/2 - 100, 280, 'restartBtn', this.restartClicked);
